...
parser.add_argument('--prune_factor', type=int, required=True, help='This will store number for frames/prune_factor images.')
...
for line in timestamps_file:
    ...
    if image_counter % args.prune_factor:
        continue
    else:
    ...
    Image.fromarray(img).save(tokens[0]+".png")

print("We had {} frames".format(image_counter))
print("We saved {} images".format(saved_image_counter))
